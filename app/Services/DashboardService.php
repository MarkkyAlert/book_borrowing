...
class DashboardService
{
    ...
    /**
     * ==========================================================================
     * 🎯 จุดประสงค์: จำนวนจริงของหนังสือที่ stock ถึงเกณฑ์ (ไม่ถูก LIMIT ตัด)
     * ==========================================================================
     * ⚠️ ใช้คู่กับ getLowStockBooks() เสมอ — ตัวนั้นให้ "รายการที่จะโชว์"
     *    ตัวนี้ให้ "จำนวนที่มีจริง" ห้ามเอา count() ของตัวแรกมาใช้แทน
     */
    public function getLowStockCount(int $threshold = 2): int
    {
        return $this->bookRepo->countLowStock($threshold);
    }
