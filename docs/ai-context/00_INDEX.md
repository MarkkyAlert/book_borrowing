...
> อัปเดตล่าสุด: 2026-08-28 — ปิด F-01…F-34 ครบทุกข้อ (ชุดทดสอบ 396/396 · 29 ชุด)
> · **F-35…F-51 ยังไม่ได้แก้** — เจอจากการทดสอบสวมบทบาทบรรณารักษ์บนข้อมูลขนาดจริง (ส่วนใหญ่เป็น UX ไม่ใช่ความถูกต้องของข้อมูล)
...
| 8 | [FINDINGS.md](FINDINGS.md) | จุดที่ Context/Comment **ไม่ตรง** กับโค้ด + บั๊กที่เจอจากการทดสอบ · **F-01…F-34 ปิดครบ** (แก้โค้ด 31 · อัปเดตเอกสาร 3) · **F-35…F-52 ยังค้าง** (🔴 3 · 🟠 9 · 🟡 6) + รายการ 8 ฟีเจอร์ที่ห้องสมุดจริงต้องใช้แต่ยังไม่มี |
...
- 18,500 บรรทัด PHP + ชุดทดสอบ 396 เคส ใน 29 ชุด (**ผ่าน 396/396**) + ชุดทดสอบ concurrency แยกอีก 12 เคส
...
| **L2** ห้องสมุดโรงเรียนขนาดจริง | `tests/fixtures/seed_school_library.php` | 204 นักเรียน / 405 เล่ม / 12 หมวด / 2,000 การยืม / 154 ยืมค้าง / 400 ค่าปรับค้าง / 31 การจอง — ขนาดและหน้าตาเหมือนของจริง ใช้ทดสอบ UX ("หาของเจอไหม" / การแบ่งหน้า 100 หน้า) | `php tests/fixtures/seed_school_library.php` |
...
| Test suite (`php tests/run_all_tests.php 123456`) | **396/396 ผ่าน (100%)** — 29 ชุด (service, DB constraint, deadlock, pagination, search index, offline assets, security/data-integrity/concurrency gap analysis, HTTP, upload security ฯลฯ) ใช้เวลา ~8 วินาที + ล้างข้อมูลให้อัตโนมัติเมื่อจบ |
