...
| 8 | [FINDINGS.md](FINDINGS.md) | จุดที่ Context/Comment **ไม่ตรง** กับโค้ด + บั๊กที่เจอจากการทดสอบ (F-01…F-34) — **ปิดครบทุกข้อ**: แก้โค้ด 31 · ตรวจแล้วอัปเดตเอกสารให้ตรง 3 (F-06, F-10, F-11) |
