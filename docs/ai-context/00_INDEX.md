...
> อัปเดตล่าสุด: 2026-08-30 — ปิด **F-01…F-54 ครบทุกข้อ** + **ROADMAP ข้อ 0–5 ครบ** + 8 งานประจำของห้องสมุด + เลขเรียกหนังสือ + ใบรายชื่อโทรตาม (ชุดทดสอบ 930/930 · 59 ชุด)
...
- 18,500 บรรทัด PHP + ชุดทดสอบ 930 เคส ใน 59 ชุด (**ผ่าน 930/930**) + ชุดทดสอบ concurrency แยกอีก 12 เคส
...
| Test suite (`php tests/run_all_tests.php 123456`) | **930/930 ผ่าน (100%)** — 59 ชุด (service, DB constraint, deadlock, pagination, search index, offline assets, security/data-integrity/concurrency gap analysis, HTTP, upload security ฯลฯ) ใช้เวลา ~22 วินาที + ล้างข้อมูลให้อัตโนมัติเมื่อจบ |
