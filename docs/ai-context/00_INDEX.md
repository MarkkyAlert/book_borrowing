...
> อัปเดตล่าสุด: 2026-08-29 — ปิด F-01…F-34 + ROADMAP ข้อ 0–5 + F-35…F-46 · F-51 · F-52 (ชุดทดสอบ 734/734 · 45 ชุด)
> · **F-53 แก้แล้ว** — บังคับเปลี่ยนรหัสตอนล็อกอินครั้งแรก + backfill ให้ลูกค้าเดิม
> · **F-47…F-50 · F-54 ยังไม่ได้แก้** (🟡 UX หน้าเคาน์เตอร์ + ตัวติดตั้งไม่ตรวจสิทธิ์เขียน `uploads/`) — เจอจากการทดสอบสวมบทบาทบรรณารักษ์บนข้อมูลขนาดจริง
...
| 8 | [FINDINGS.md](FINDINGS.md) | จุดที่ Context/Comment **ไม่ตรง** กับโค้ด + บั๊กที่เจอจากการทดสอบ · **F-01…F-34 ปิดครบ** (แก้โค้ด 31 · อัปเดตเอกสาร 3) · **F-35…F-46 · F-51 · F-52 ปิดแล้ว** · ยังค้าง 🟡 F-47…F-50 · F-54 + รายการ 8 งานประจำของห้องสมุดที่ยังไม่มี |
...
- 18,500 บรรทัด PHP + ชุดทดสอบ 734 เคส ใน 45 ชุด (**ผ่าน 734/734**) + ชุดทดสอบ concurrency แยกอีก 12 เคส
...
| Test suite (`php tests/run_all_tests.php 123456`) | **734/734 ผ่าน (100%)** — 45 ชุด (service, DB constraint, deadlock, pagination, search index, offline assets, security/data-integrity/concurrency gap analysis, HTTP, upload security ฯลฯ) ใช้เวลา ~22 วินาที + ล้างข้อมูลให้อัตโนมัติเมื่อจบ |
