...
> อัปเดตล่าสุด: 2026-08-28 — แก้ F-01…F-05, F-08, F-09, F-12…F-27 แล้ว (ชุดทดสอบ 145/145)
...
| 8 | [FINDINGS.md](FINDINGS.md) | จุดที่ Context/Comment **ไม่ตรง** กับโค้ด + บั๊กที่เจอจากการทดสอบ (F-01…F-27) — แก้แล้ว 23 · เชิงบริบท 4 · ไม่มีค้าง |
