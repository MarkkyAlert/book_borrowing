...
> อัปเดตล่าสุด: 2026-08-27 — แก้ F-01…F-05, F-08, F-12…F-23 แล้ว (ชุดทดสอบ 126/126)
...
| 8 | [FINDINGS.md](FINDINGS.md) | จุดที่ Context/Comment **ไม่ตรง** กับโค้ด + บั๊กที่เจอจากการทดสอบ (F-01…F-23) — แก้แล้ว 18 · เชิงบริบท 5 · ไม่มีค้าง |
