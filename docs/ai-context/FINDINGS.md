...
> F-20 เจอตอนทดสอบเจ้าหน้าที่ 2 คนกดพร้อมกัน — **ยังไม่แก้ รอตัดสินใจ** (ข้อมูลไม่เสีย แต่ UX + ข้อความหลุด)
...
## 🟡 F-20 — [ยังไม่แก้] Deadlock ของ MySQL หลุดขึ้นหน้าจอเป็น error ดิบ ตอนแย่งหนังสือเล่มสุดท้าย
...
**ทดสอบซ้ำได้ด้วย:** `php tests/test_concurrency_http.php` (เคส CC-04c จะรายงานเมื่อเจอ deadlock)
