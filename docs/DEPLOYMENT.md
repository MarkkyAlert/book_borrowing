...
- **Password Reset:** ตั้ง SMTP ที่ **ตั้งค่าระบบ → การส่งอีเมล** แล้วกด "ทดสอบส่ง" ให้ผ่านก่อน จากนั้นหน้า "ลืมรหัสผ่าน" จะส่งลิงก์ตั้งรหัสใหม่ให้ทางอีเมลได้ · 🔴 **ค่าเริ่มต้นคือปิด** ถ้าไม่ตั้ง SMTP ผู้ดูแลตั้งรหัสให้ที่หน้าจัดการสมาชิกได้ (ระบบบังคับให้เจ้าตัวเปลี่ยนรหัสทันทีที่เข้าใช้) — **ไม่ต้องไปแก้ที่ฐานข้อมูล** ยกเว้นกรณีลืมรหัส admin ตัวเดียวในระบบ ดู README หัวข้อ "ลืมรหัสผ่าน Admin"
