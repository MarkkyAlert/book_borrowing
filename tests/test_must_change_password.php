...
// E3 — backfill จำกัดที่ role=member (บัญชีเจ้าหน้าที่ admin ตั้งเอง ไม่ได้มาจากไฟล์นำเข้า)
check('MCP-E3', $flagIn($staffAccount) === 0,
    'บัญชีเจ้าหน้าที่ไม่ถูกแตะ (backfill จำกัด role=member)',
    '🔴 บัญชีเจ้าหน้าที่โดนติดธงด้วย — เสี่ยงล็อกคนดูแลระบบออกจากระบบตัวเอง');
...
check('MCP-E6', (bool) preg_match('/ติดธงบังคับเปลี่ยนรหัส\s*\d+\s*คน/u', $firstRun),
    'migration รายงานจำนวนคนที่ถูกติดธง — ผู้ติดตั้งเห็นว่าเกิดอะไรขึ้น',
