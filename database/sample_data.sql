...
-- =====================================================
-- 🔴 สำคัญ: หลัง import ไฟล์นี้ ต้องรันคำสั่งนี้ต่อ
--     php database/rebuild_search_index.php
--
-- เพราะอะไร: การค้นหาหนังสือใช้ FULLTEXT บนคอลัมน์ `search_tokens`
-- ซึ่ง **PHP เป็นคนสร้าง** (SQL คำนวณเองไม่ได้ ต้องตัดข้อความเป็นชิ้นละ 3 ตัวอักษร)
-- ถ้าไม่รัน หนังสือจากไฟล์นี้จะ **ค้นหาไม่เจอ** ทั้งที่แสดงในรายการปกติ
-- =====================================================
...
-- =====================================================
-- 🔴 อย่าลืม: php database/rebuild_search_index.php
--    (ดูเหตุผลที่หัวไฟล์ — ไม่รันแล้วค้นหาหนังสือไม่เจอ)
-- =====================================================
